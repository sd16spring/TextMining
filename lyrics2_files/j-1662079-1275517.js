...
var ft1662079 = {
	confID:window.ftConfID_1662079||"0",
	GUID:window.ftGUID_1662079||"99999999999",
	ftId:'',
    ftImpId: window.ftImp1662079 && window.ftImp1662079.impID || '',
	params:window.ftParams_1662079||"",
	segment:window.ftSegment_1662079||"",
	segmentList:window.ftSegmentList_1662079||[],
	keyword:window.ftKeyword_1662079||"",
	ftReturn: window.ftReturn_1662079||"",
	exttrack:[],
	extscript:[""],
	pID:"1662079",
	cID:"54265",
	campaignID:"58197",
	siteName:"MediaMath",
	placementDescription:"SLNGDUSATONNAGDTDISMT1PPRxxxxxxxxxxAZFIRESxxxxxxx728x090",
	creativeID:"1275517",
	width:728,
	height:90,
	divID:"ftdiv1662079",
	frameID:"ftframe1662079",
	altImgID:"ftalt1662079",
	altText:"Click here",
	altImgTarget:"_blank",
	altImgHref:"http://servedby.flashtalking.com/click/8/58197;1662079;1275517;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.sling.com/devices/amazon?cvosrc=Display.MediaMath.TONNAG&cvo_strategy=[FT_MMSTRATEGY]&cvo_dealid=[FT_MMDEALID]&cvo_site=[FT_MMDOMAIN]&cvo_versionid=[FT_CONFID]&cvo_pid=SLNGD_USA_TONNAG_DT_DIS_MT1_PPR_xxxxxxxxxx_AZFIRES_xxxxxxx_728x090",
    tracking3rdParty: {
        videoQuartiles: JSON.parse('[%thirdparty_video_quartiles%]'.replace(/^(\[%\w+%])?$/, '{}')),
        userEngagement: '[%thirdparty_user_engagement%]'.replace(/^\[%\w+%\]$/, '')
    },
	clickTags: ["http://servedby.flashtalking.com/click/8/58197;1662079;1275517;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.sling.com/devices/amazon?cvosrc=Display.MediaMath.TONNAG&cvo_strategy=[FT_MMSTRATEGY]&cvo_dealid=[FT_MMDEALID]&cvo_site=[FT_MMDOMAIN]&cvo_versionid=[FT_CONFID]&cvo_pid=SLNGD_USA_TONNAG_DT_DIS_MT1_PPR_xxxxxxxxxx_AZFIRES_xxxxxxx_728x090"],
	altImg:"http://servedby.flashtalking.com/imp/8/58197;1662079;204;gif;MediaMath;SLNGDUSATONNAGDTDISMT1PPRxxxxxxxxxxAZFIRESxxxxxxx728x090/?",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/8/58197;1662079;202;pixel;MediaMath;SLNGDUSATONNAGDTDISMT1PPRxxxxxxxxxxAZFIRESxxxxxxx728x090/?",
    stump: "http://servedby.flashtalking.com",
	file:"http://cdn.flashtalking.com/54265/1275517/SLG1022_amazon_fire_728x90.html",
	serveDOM:"http://cdn.flashtalking.com",
	switchArray:["altImg","file", "serveDOM", "statBaseURL","altImgHref", "viewableImpressionURL"],
	statBaseURL:"http://stat8.flashtalking.com/reportV3/ft.stat?61890330-",
	centreAd:true,
	adWindow:null,
	mvt:false,
	blockBrowsers:"".split(","),
	...
	secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m1662079[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
	storeGUID:/iP(ad|hone|od)/.test(navigator.appVersion),
	scriptLocation: document.getElementById('ftscript_m1662079'),
	customPos: false,
	...
	outputDiv:function(fullAd){
		...
		if(badWrite || (window.ftImp1662079 && window.ftImp1662079.jsAppend)) {
...
(function(o) {
  ...
  var mmReplace = function(s) {
      ...
      var ftcustomArr = (window["ftCustom_" + o.pID] || "").split("___"),
        ...
        mmArr = ["[FT_MMSTRATEGY]", "[FT_MMDEALID]", "[FT_MMDOMAIN]"];
      ...
      for (var i = 0; i < ftcustomArr.length; i++) {
        ...
        if (ftcustomArr[i]) {
          ...
          s = s.replace(mmArr[i], encodeURIComponent(ftcustomArr[i]));
    ...
    trackUrl = mmReplace("https://dishdigital.sp1.convertro.com/view/vt/v1/dishdigital/15/cvo.gif?cvosrc=Display.MediaMath.TONNAG&cvo_strategy=[FT_MMSTRATEGY]&cvo_dealid=[FT_MMDEALID]&cvo_site=[FT_MMDOMAIN]&cvo_versionid=[FT_CONFID]&cvo_pid=SLNGD_USA_TONNAG_DT_DIS_MT1_PPR_xxxxxxxxxx_AZFIRES_xxxxxxx_728x090");
  ...
  trackUrl = (o.secure) ? trackUrl.replace(/^http:/, "https:") : trackUrl;
  ...
  new Image().src = o.replaceMacros(trackUrl);
  ...
  for (var i = o.clickTags.length; i--;) {
    ...
    o.clickTags[i] = mmReplace(o.clickTags[i]);
  ...
  o.altImgHref = mmReplace(o.altImgHref);
