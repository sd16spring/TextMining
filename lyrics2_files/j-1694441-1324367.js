...
var ft1694441 = {
	confID:window.ftConfID_1694441||"0",
	GUID:window.ftGUID_1694441||"99999999999",
	ftId:'',
    ftImpId: window.ftImp1694441 && window.ftImp1694441.impID || '',
	params:window.ftParams_1694441||"",
	segment:window.ftSegment_1694441||"",
	segmentList:window.ftSegmentList_1694441||[],
	keyword:window.ftKeyword_1694441||"",
	ftReturn: window.ftReturn_1694441||"",
	exttrack:["https://dishdigital.sp1.convertro.com/view/vt/v1/dishdigital/15/cvo.gif?cvosrc=Display.GDN.SPORTS&cvo_pid=SLNGD_USA_SPORTS_DT_DIS_GDN_PPR_CUSSPTWOCA_CABSHAK_XXXXXX_160x600"],
	extscript:[""],
	pID:"1694441",
	cID:"54359",
	campaignID:"58119",
	siteName:"GoogleDisplayNetwork",
	placementDescription:"SLNGDUSASPORTSDTDISGDNPPRCUSSPTWOCACABSHAKXXXXXX160x600",
	creativeID:"1324367",
	width:160,
	height:600,
	divID:"ftdiv1694441",
	frameID:"ftframe1694441",
	altImgID:"ftalt1694441",
	altText:"Click here",
	altImgTarget:"_blank",
	altImgHref:"http://servedby.flashtalking.com/click/8/58119;1694441;1324367;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://www.sling.com?cvosrc=Display.GDN.SPORTS&cvo_pid=SLNGD_USA_SPORTS_DT_DIS_GDN_PPR_CUSSPTWOCA_CABSHAK_XXXXXX_160x600&utm_source=rtbprospecting&utm_medium=display&utm_campaign=CABSHAK",
    tracking3rdParty: {
        videoQuartiles: JSON.parse('[%thirdparty_video_quartiles%]'.replace(/^(\[%\w+%])?$/, '{}')),
        userEngagement: '[%thirdparty_user_engagement%]'.replace(/^\[%\w+%\]$/, '')
    },
	clickTags: ["http://servedby.flashtalking.com/click/8/58119;1694441;1324367;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://www.sling.com?cvosrc=Display.GDN.SPORTS&cvo_pid=SLNGD_USA_SPORTS_DT_DIS_GDN_PPR_CUSSPTWOCA_CABSHAK_XXXXXX_160x600&utm_source=rtbprospecting&utm_medium=display&utm_campaign=CABSHAK"],
	altImg:"http://servedby.flashtalking.com/imp/8/58119;1694441;204;gif;GoogleDisplayNetwork;SLNGDUSASPORTSDTDISGDNPPRCUSSPTWOCACABSHAKXXXXXX160x600/?",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/8/58119;1694441;202;pixel;GoogleDisplayNetwork;SLNGDUSASPORTSDTDISGDNPPRCUSSPTWOCACABSHAKXXXXXX160x600/?",
    stump: "http://servedby.flashtalking.com",
	file:"http://cdn.flashtalking.com/54359/1324367/index.html",
	...
	statBaseURL:"http://stat8.flashtalking.com/reportV3/ft.stat?63212713-1694441;1324367;",
	centreAd:true,
    iDeviceImp:"http://servedby.flashtalking.com/imp/8/58119;1694441;207;guid;GoogleDisplayNetwork;SLNGDUSASPORTSDTDISGDNPPRCUSSPTWOCACABSHAKXXXXXX160x600/?ft_guid=[%"+"FT_GUID%]&cachebuster=[%"+"CACHEBUSTER%]",
	adWindow:null,
	mvt:false,
	blockBrowsers:"".split(","),
	eventListeners:{},
	...
	secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m1694441[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
	storeGUID:/iP(ad|hone|od)/.test(navigator.appVersion),
	scriptLocation: document.getElementById('ftscript_m1694441'),
	customPos: false,
	...
	outputDiv:function(fullAd){
		...
		if(badWrite || (window.ftImp1694441 && window.ftImp1694441.jsAppend)) {
